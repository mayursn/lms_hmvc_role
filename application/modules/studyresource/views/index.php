...
<?php
<<<<<<< HEAD
$create = create_permission($permission, 'StudyResource');
$read = read_permission($permission, 'StudyResource');
$update = update_permisssion($permission, 'StudyResource');
$delete = delete_permission($permission, 'StudyResource');
=======
