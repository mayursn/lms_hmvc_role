                                                    ...
                                                    <ul><?php
                                                        ...
                                                        <ul>
                                                            ...
                                                            <td>  <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/participate_editquestion/<?php echo $rowq->sq_id; ?>');"  data-toggle="tooltip" data-placement="top" ><span class="label label-primary mr6 mb6"><i class="fa fa-pencil" aria-hidden="true"></i>Edit</span></a>
                                                                ...
                                                                <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>participate/delete_question/<?php echo $rowq->sq_id; ?>');"  data-toggle="tooltip" data-placement="top" ><span class="label label-danger mr6 mb6"><i class="fa fa-trash-o" aria-hidden="true"></i>Delete</span></a>	</td>
                                                            </tr>
                                                        <?php endforeach; ?>                        
                                                        </tbody>
                                                        </table>
